...
songplay_table_create = ("""CREATE TABLE song_play (songplay_id SERIAL PRIMARY KEY, \
                                                    start_time varchar, \
                                                    user_id int, \
                                                    level varchar, \
                                                    song_id varchar, \
...
time_table_create = ("""CREATE TABLE time (start_time varchar,
                                           hour int,
                                           day int,
                                           week int,
                                           month varchar,
...
songplay_table_insert = ("""INSERT INTO song_play (start_time,
                                                    user_id,
                                                    level,
                                                    song_id,
                                                    artist_id,
